...
<div class="max-w-2xl mx-auto bg-white rounded-[2.5rem] p-12 border border-gray-100 shadow-sm relative overflow-hidden">
    ...
    <div class="relative z-10">
        <div class="mb-12">
            <h3 class="text-3xl font-bold text-gray-900 mb-2">Category Creation</h3>
            <p class="text-gray-500 font-bold uppercase tracking-widest text-[10px]">Step: Define a new program classification</p>
        </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div class="space-y-4">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required class="w-full bg-gray-50 border-0 border-b-2 border-gray-200 focus:border-accent p-4 text-gray-900 outline-none transition-colors rounded-2xl" placeholder="e.g. Competitive Exams">
                    @error('name')
            ...
            <div class="flex gap-6 mt-16">
                <button type="submit" class="flex-grow gold-button text-primary font-black py-5 rounded-3xl uppercase tracking-widest text-xs shadow-2xl transition-all">Create Category</button>
