    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-dark text-white shrink-0 overflow-y-auto hidden md:block">
            ...
            <nav class="mt-6 px-4 space-y-2">
                ...
                <a href="{{ route('admin.categories.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-800 transition-colors {{ request()->routeIs('admin.categories*') ? 'bg-gray-800 text-accent font-bold' : 'text-gray-400' }}">
